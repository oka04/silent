...
#include "..\\Utility\\IntervalManage.h"
...
public:
	...
	// 引　数：背景色
	//=============================================================================
	void Clear(D3DCOLOR backgroundColor);
	...
	void BeginMiniMap(const D3DXVECTOR2& center, float radius, int div);
	...
	//=============================================================================
	void PlaySE(std::string strFileName, DWORD priority = 0);
#endif
	...
	// ＳＥの周波数をリセット
	//=============================================================================
	void SetSEStandardFrequency(std::string strFileName);

	//=============================================================================
	// ＳＥの周波数を調整
	// 引　数：int 増減させる周波数
	//=============================================================================
	void SetSEFrequency(std::string strFileName, int value);

	//=============================================================================
	// ＳＥのパンをリセット
	//=============================================================================
	void SetSEStandardPan(std::string strFileName);

	//=============================================================================
	// ＳＥのパンを調整
	// 引　数：int 増減させる数値
	//=============================================================================
	void SetSEPan(std::string strFileName, int value);

	//=============================================================================
	// ＳＥのボリュームをリセット
	//=============================================================================
	void SetSEStandardVolume(std::string strFileName);

	//=============================================================================
	// ＳＥのボリュームを調整
	// 引　数：int 増減させる数値
	//=============================================================================
	void SetSEVolume(std::string strFileName, int value);
#endif
	...
	//=============================================================================
	void AddModel(std::string strFileName, bool bCreateAdjacencyData = false);
	...
	// 　　　　線の色
	//=============================================================================
	void DrawLine(const D3DXVECTOR2 startPosition, const D3DXVECTOR2 endPosition, D3DCOLOR color);
	...
	// 　　　　線の色
	//=============================================================================
	void DrawLine(const int startX, const int startY, const int endX, const int endY, D3DCOLOR color);
	...
	// 　　　　プロジェクション変換行列のポインタ
	//=============================================================================
	void DrawLine(const D3DXVECTOR3 startPosition, const D3DXVECTOR3 endPosition, D3DCOLOR color, const D3DXMATRIX* pView, const D3DXMATRIX* pProjection);
	...
	void DrawFilledCircle(const D3DXVECTOR2& center, float radius, int div, D3DCOLOR color);

	LPDIRECT3DSURFACE9 BeginOffScreenRender(int width, int height);
	void EndOffScreenRender(LPDIRECT3DSURFACE9 pOldBackBuffer, const std::string& fileName);
#ifdef USE_IMGUI
	//wmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmwmw
	//
	// 日本語入力
